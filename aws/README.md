...
This is a sample template for webhook-proxy - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name webhook-proxy --query 'Stacks[].Outputs'
```
